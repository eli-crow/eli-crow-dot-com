...
<template>
    <div
        class="bg-gray-50 self-stretch flex flex-col relative flex-1 md:fixed md:inset-0 md:flex-row md:gap-8 md:p-8"
    >
        <!-- 
        ...
        <header
            ...
            class="flex flex-col flex-grow relative z-10 w-full p-8 coarse:pt-4 rounded-t-3xl bg-white dark:bg-gray-100 md:p-4 md:max-w-xs md:!bg-transparent md:dark:!bg-transparent md:rounded-none md:flex-auto md:self-center"
        >
            <!-- draggable indicator -->
            <div
                class="fine:hidden md:hidden h-[0.3333rem] mb-2 w-12 self-center bg-gray-100 dark:bg-gray-200 rounded-full"
            />
            ...
            <div class="flex gap-3 items-center mb-5">
                ...
                <h1
                    class="font-light text-2xl text-gray-800 leading-[1.42] flex-1"
                >{{ props.title }}</h1>
            </div>
        ...
        <main
            class="sticky top-6 flex flex-[1,0,20rem] flex-col order-first justify-center m-6 my-6 min-h-0 min-w-0 md:flex-shrink md:h-auto md:m-0 md:p-8 md:top-auto md:flex-grow md:bg-white md:dark:bg-gray-100 md:relative md:rounded-sm md:order-none"
        >
            <suspense>
                <template #default>
