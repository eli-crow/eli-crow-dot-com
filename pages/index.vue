...
<template>
  <div class="site w-full max-w-[1440px] py-8">
          ...
          <strong class="block font-light">
            ...
            <span class="block my-[0.7ch]">
              <span class="gooey-text">
                <span class="gooey-text-inner">designer and developer</span>
              </span>
            </span>
          </strong>
    ...
    <main class="card-group">
      ...
      <Card pressable link tag="article">
        <video preload="metadata" muted autoplay loop playsinline src="/blog/view-transition-design-after.mp4" />
        <div class="p-8">
      ...
      <Card pressable link tag="article">
        ...
        <NuxtLink to="/bead" class="card-icon flex items-center" title="View 3d Model">
      ...
      <Card pressable link tag="article">
        ...
        <NuxtLink to="/ouija" class="card-icon flex items-center" title="Make contact">
          <span class="mr-3 sm:hidden">Interact</span>
          <Icon icon="cursor" />
        </NuxtLink>
      </Card>
      ...
      <Card pressable link tag="article">
        ...
        <NuxtLink to="/ute" class="card-icon flex items-center" title="View 3d Model">
          <span class="mr-3 sm:hidden">Interact</span>
          <Icon icon="threeD" />
        </NuxtLink>
      </Card>
      ...
      <Card pressable link class="p-8" tag="article">
        ...
        <p><time>2021, Blender</time></p>
        <NuxtLink to="/losing-sleep" class="card-icon flex items-center" title="View 3d Model">
          <span class="mr-3 sm:hidden">Interact</span>
          <Icon icon="threeD" />
        </NuxtLink>
      </Card>
